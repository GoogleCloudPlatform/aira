...
import { CATEGORY_ORGANIZATIONS, MODE_DELETE } from "@/constants";
import { useTranslations } from "next-intl";
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle } from "@/components/ui/dialog";

const FormDeleteOrganization : React.FC<TFormDeleteProps> = ({ mode, title, formData, setOpen }) => {

    const t = useTranslations("form.organization.delete");
...
export default FormDeleteOrganization;